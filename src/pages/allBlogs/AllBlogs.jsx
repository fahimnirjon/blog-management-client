...
const AllBlogs = () => {
  ...
  const blogsUrl = "https://cinema-ghor-server-side-main.vercel.app/blogposts";
  ...
  const filterByInput = `https://cinema-ghor-server-side-main.vercel.app/searchInput/${searchInput}`;
  // click handler
  ...
  // filter by category
  const filterByCategory = `https://cinema-ghor-server-side-main.vercel.app/category/${categories}`;
